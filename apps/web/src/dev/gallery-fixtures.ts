import type { OrganizationStatusItem } from '@musiclatte/contracts';
...
export const galleryOrganizationStates: OrganizationStatusItem[] = [
  {
  ...
  {
    target: { kind: 'track', trackId: 'song-3' },
    state: 'processing',
    reason: 'job_active',
    stage: 'moving',
    changedAt: 2,
  ...
  {
    target: { kind: 'track', trackId: 'song-4' },
    state: 'attention',
    reason: 'job_failed',
    stage: 'failed',
    changedAt: 3,
  ...
  {
    target: { kind: 'track', trackId: 'song-5' },
    state: 'unknown',
