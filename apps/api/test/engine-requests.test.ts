...
describe('durable engine requests', () => {
  ...
  it('should migrate v7 without changing existing rows and restore the durable mailbox', async () => {
    ...
    s.c.db.connection.exec(`
      ...
      DROP TRIGGER organization_events_no_update;
      DROP TABLE organization_events;
      DROP TABLE organization_source_locations;
      DROP TABLE organization_reference_checkpoints;
      DROP TRIGGER organization_attempts_no_delete;
      DROP TABLE organization_attempts;
      DROP TABLE organization_items;
      DROP TABLE organization_jobs;
      DROP TABLE listening_deliveries;
      DROP TABLE listening_events;
      DROP TABLE mix_operations;
      DROP TABLE saved_mixes;
      ...
      DROP TABLE curation_inventory_failures;
    ...
    expect(migrated.connection.prepare('PRAGMA user_version').get()).toEqual({ user_version: 28 });
